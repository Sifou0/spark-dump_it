    ...
    <div class="flex w-screen h-1/3 items-center justify-evenly my-32">
        <form action="login" method="post" class="w-full max-w-md">
            ...
            <div class="md:flex md:items-center">
                ...
                <div class="md:w-2/3">
                    <button class="focus:shadow-outline rounded bg-[#357cce] px-4 py-2 font-bold text-white shadow hover:bg-[#3D8CE6] focus:outline-none" type="submit">Se connecter</button>
                </div>
            </div>
        </form>
    </div>
